...
object NSIGetAccountBehaviour {
  ...
  def getAccountByNino(nino: String, correlationId: Option[String]): Either[ErrorDetails, NSIGetAccountByNinoResponse] = // scalastyle:ignore cyclomatic.complexity line.size.limit
    nino match {
      case n if (n.startsWith("EM200") || n.startsWith("EL07")) || n.startsWith("AC") || n.startsWith("AS409") ⇒ Right(NSIGetAccountByNinoResponse.bethNSIResponse(correlationId))
      ...
      case n if n.startsWith("EM0") && n.endsWith("001A") ⇒ Right(NSIGetAccountByNinoResponse.bethNSIResponse(correlationId))
      case n if n.startsWith("EM0") && n.endsWith("002A") ⇒ Right(NSIGetAccountByNinoResponse.peteNSIResponse(correlationId))
      case n if n.startsWith("EM0") && n.endsWith("003A") ⇒ Right(NSIGetAccountByNinoResponse.lauraNSIResponse(correlationId))
      case n if n.startsWith("EM0") && n.endsWith("004A") ⇒ Right(NSIGetAccountByNinoResponse.tonyNSIResponse(correlationId))
      case n if n.startsWith("EM0") && n.endsWith("005A") ⇒ Right(NSIGetAccountByNinoResponse.monikaNSIResponse(correlationId))
      case n if n.startsWith("EM0") && n.endsWith("006A") ⇒ Right(NSIGetAccountByNinoResponse.happyNSIResponse(correlationId))
      case n if n.startsWith("EM0") && n.endsWith("007A") ⇒ Right(NSIGetAccountByNinoResponse.takenNSIResponse(correlationId))
      case n if n.startsWith("EM0") && n.endsWith("008A") ⇒ Right(NSIGetAccountByNinoResponse.spencerNSIResponse(correlationId))
      case n if n.startsWith("EM0") && n.endsWith("009A") ⇒ Right(NSIGetAccountByNinoResponse.alexNSIResponse(correlationId))
  ...
  object NSIGetAccountByNinoResponse {
    ...
    val happyTerms: List[Term] = List[Term](Term(1, LocalDate.of(2014, 3, 1), LocalDate.of(2016, 2, 29), "1200.00", "600.00", "600.00"),
    ...
    val takenTerms: List[Term] = List[Term](Term(1, LocalDate.of(2014, 3, 1), LocalDate.of(2016, 2, 29), "1200.00", "600.00", "600.00"),
    ...
    val spencerTerms: List[Term] = List[Term](Term(1, LocalDate.of(2016, 3, 1), LocalDate.of(2018, 2, 28), "832.00", "416.00", "416.00"),
    ...
    val alexTerms: List[Term] = List[Term](Term(1, LocalDate.of(2015, 2, 1), LocalDate.of(2017, 1, 31), "900.00", "450.00", "450.00"),
    ...
    val closedTerms: List[Term] = List[Term](Term(1, LocalDate.of(2017, 11, 1), LocalDate.of(2019, 10, 31), "250.00", "00.00", "0.00"),
                                             Term(2, LocalDate.of(2019, 11, 1), LocalDate.of(2021, 10, 31), "0.00", "0.00", "0.00"))
